...
import { Trash2, Plus, Minus, ArrowLeft, IndianRupee } from "lucide-react";
...
const Cart = () => {
    ...
    if (cartItems.length === 0) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-transparent px-4 pt-32 pb-12 md:px-0 relative">
                {/* Background gradient */}
                                        ...
                                        <div className={`w-2/3 flex flex-col justify-center ${isSingleItem ? 'p-8 gap-6' : 'p-4 gap-3'}`}>
                                            <div className={`${isSingleItem ? 'space-y-4' : 'space-y-2'}`}>
                                                ...
                                                <div className={`border-t border-gray-200 ${isSingleItem ? 'pt-4' : 'pt-2'}`}>
                                                    <p className={`${isSingleItem ? 'text-4xl' : 'text-2xl'} font-bold text-gray-900 flex items-center`}>
                                                        <IndianRupee size={isSingleItem ? 32 : 18} className="mr-1" strokeWidth={3} />
                    ...
                    <div className="w-full sm:w-auto sm:min-w-[400px] md:w-[600px] lg:w-[800px] xl:w-[1000px] border-t-2 border-gray-300 pt-6 space-y-4">
                        <div className="flex justify-between text-sm text-gray-600 font-medium">
                            <span>{t('subtotal')}</span>
                             <span className="flex items-center"><IndianRupee size={12} className="mr-0.5" strokeWidth={3} />{subtotal}</span>
                        </div>
                        <div className="flex justify-between text-sm text-gray-600 font-medium">
                        ...
                        <div className="flex justify-between text-lg font-bold text-black border-t border-gray-200 pt-3">
                            <span>{t('total')}</span>
                             <span className="flex items-center"><IndianRupee size={18} className="mr-0.5" strokeWidth={3} />{subtotal}</span>
                        </div>
