...
export default function LegalitiesPage() {
  ...
  const renderHome = () => (
    <div className="min-h-screen pt-32 pb-12 bg-transparent flex items-center justify-center px-4 relative">
      {/* Background gradient */}
...
>
  ...
  const renderPolicyPage = (title, content) => (
    <div className="min-h-screen pt-32 pb-12 bg-transparent px-4 sm:px-6 md:px-8 relative">
      {/* Background gradient */}
      <div className="fixed inset-0 -z-20">
        <div
          className="absolute inset-0"
